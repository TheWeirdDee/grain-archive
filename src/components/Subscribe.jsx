        ...
        <section className="relative w-full h-[300px] md:h-[500px] flex items-center justify-center overflow-hidden">
            ...
            <div className="relative z-10 w-[90%] md:w-[80%] max-w-[1000px] aspect-[21/9] md:aspect-[3/1] flex flex-col items-center justify-center text-center px-6 md:px-12">
                ...
                <div className="relative z-20 flex flex-col items-center">
                    <h2
                        className="text-4xl md:text-7xl mb-2 italic"
                    ...
                    <button className="bg-black text-white px-8 md:px-12 py-3 md:py-4 text-sm md:text-base font-bold uppercase tracking-widest hover:bg-gray-900 transition-colors shadow-lg">
                        Subscribe
                    </button>
                </div>
            </div>
