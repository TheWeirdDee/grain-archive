...
const Subscribe = () => {
    return (
        <section className="relative w-full h-[250px] md:h-[500px] flex items-center justify-center overflow-hidden">
            <div
            ...
            <div className="relative z-10 w-[90%] md:w-[80%] max-w-[1000px] aspect-[8/13] md:aspect-[8/13] flex flex-col items-center justify-center text-center px-6 md:px-12">
                <img
                    src={SubscribeImage}
                ...
                <div className="relative z-20 flex flex-col items-center">
                    ...
                    <p className="text-black text-xs md:text-sm font-medium mb-2 md:mb-6 max-w-[280px] md:max-w-none">
